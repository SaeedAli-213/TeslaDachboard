...
Page {
    ...
    property var currentLoc: QtPositioning.coordinate(
                                 28.4595, 77.0266) // current location
    ...
    Map {
        ...
        plugin: Plugin {
            ...
            PluginParameter {
                ...
                value: "mapbox://styles/haseebtariq1998/clm1o9olf00rf01qxb3nr9n82"
            }
        }
        ...
        MapQuickItem {
            ...
            sourceItem: Rectangle {
                ...
                Image {
                    ...
                    width: adaptive.width(100) * (map.zoomLevel / 17)
                    height: adaptive.height(100) * (map.zoomLevel / 17)
                    source: "/home/saeed/CarDachboard/Map/CarMarker.png"
                    anchors.centerIn: parent
                }
            }
        ...
        MapQuickItem {
            ...
            sourceItem: Rectangle {
                ...
                AnimatedImage {
                    width: adaptive.width(50) * (map.zoomLevel / 17)
                    height: adaptive.height(50) * (map.zoomLevel / 17)
                    source: "animIcons/icons8-destination.gif"
                    anchors.centerIn: parent
                }
            }
        }
        ...
        RouteModel {
            ...
            onRoutesChanged: {
                map.center = routeModel.get(
                            0).path[(routeModel.get(
                                         0).path.length / 2).toFixed(0)]
                destinationMarker.coordinate = QtPositioning.coordinate(
                            26.2124,
                            78.1772) //routeModel.get(0).path[ routeModel.get(0).path.length -1 ]
